...
>
> 现状一句话：**26231/26232 两期已全流程分析：采集 552+699=1251 条记录 → 命中 97+129=226 条（17.57%/18.45%），
> 已沉淀命中规律 226 条（`docs/规律/26231.md`、`26232.md`）。26230 期命中复核定稿：采集 694 条 → 命中 18 条（2.59%），
...
| 26231 | 1 8 7 9 9 | 552 条 | 97 条 | 17.57% | —（未跑多位置重读） | **97 条**（docs/规律/26231.md） |
