...
>
> 现状一句话：**26231/26232 两期已全流程分析：采集 589+741=1330 条记录 → 命中 108+140=248 条（18.34%/18.89%），
> 已沉淀命中规律 248 条（`docs/规律/26231.md`、`26232.md`）。26230 期命中复核定稿：698 条 → 命中 18 条（2.58%），
...
| 26231 | 1 8 7 9 9 | 589 条 | 108 条 | 18.34% | —（未跑多位置重读） | **108 条**（docs/规律/26231.md） |
| 26232 | 8 0 2 3 3 | 741 条 | 140 条 | 18.89% | —（未跑多位置重读） | **140 条**（docs/规律/26232.md） |
...
>   26230 跑过重读并剔除 2 条假命中，故命中率口径略严、数值更低（2.58%）。
